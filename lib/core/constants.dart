...
Map<int, Color> color0 = {
  50: const Color.fromRGBO(108, 99, 225, .1),
  100: const Color.fromRGBO(108, 99, 225, .2),
  200: const Color.fromRGBO(108, 99, 225, .3),
  300: const Color.fromRGBO(108, 99, 225, .4),
  400: const Color.fromRGBO(108, 99, 225, .5),
  500: const Color.fromRGBO(108, 99, 225, .6),
  600: const Color.fromRGBO(108, 99, 225, .7),
  700: const Color.fromRGBO(108, 99, 225, .8),
  800: const Color.fromRGBO(108, 99, 225, .9),
  900: const Color.fromRGBO(108, 99, 225, 1.0),
};

// 0xFF252525 #252525
Map<int, Color> color1 = {
  50: const Color.fromRGBO(37, 37, 37, .1),
  100: const Color.fromRGBO(37, 37, 37, .2),
  200: const Color.fromRGBO(37, 37, 37, .3),
  300: const Color.fromRGBO(37, 37, 37, .4),
  400: const Color.fromRGBO(37, 37, 37, .5),
  500: const Color.fromRGBO(37, 37, 37, .6),
  600: const Color.fromRGBO(37, 37, 37, .7),
  700: const Color.fromRGBO(37, 37, 37, .8),
  800: const Color.fromRGBO(37, 37, 37, .9),
  900: const Color.fromRGBO(37, 37, 37, 1.0),
};

MaterialColor primaryColor = MaterialColor(0xFF6C63FF, color0);
MaterialColor secondaryColor = MaterialColor(0xFF252525, color1);
